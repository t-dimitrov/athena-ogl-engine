...
namespace Athena
{
    ...
    void Shader::SetUniformInt2(const std::string& name, const glm::vec2& value) const
    {
        GLint location = glGetUniformLocation(_programId, name.c_str());
        glUniform2i(location, static_cast<GLint>(value.x), static_cast<GLint>(value.y));
    }

    void Shader::SetUniformInt3(const std::string& name, const glm::vec3& value) const
    {
        GLint location = glGetUniformLocation(_programId, name.c_str());
        glUniform3i(location, static_cast<GLint>(value.x), static_cast<GLint>(value.y), static_cast<GLint>(value.z));
    }

    void Shader::SetUniformInt4(const std::string& name, const glm::vec4& value) const
    {
        GLint location = glGetUniformLocation(_programId, name.c_str());
